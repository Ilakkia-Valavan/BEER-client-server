class ClientMessageUtil:
    ...
    def get_spectator_registration_message(self, client_detail):
        message = {"message_type": "ACTION", "command": "REGISTER" , "data":{"client_name": client_detail["client_name"], "client_ID" : client_detail["client_ID"], "client_role": client_detail["client_role"]}}
